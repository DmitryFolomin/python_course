n=int(input()) # кол-во подаренных кубиков
count=0        # счёт рядов
total_k=0      # всего использовано кубиков
while total_k<=n:
    count +=1
    total_k += count*(count+1)//2
print(count-1)
...
# на верхушке пирамиды должен находиться 1 кубик, на втором уровне — 1 + 2 = 3 кубика, на третьем — 1 + 2 + 3 = 6 кубиков,
# и так далее. Таким образом, на i-м уровне пирамиды должно располагаться 1 + 2 + ... + (i - 1) + i кубиков.
